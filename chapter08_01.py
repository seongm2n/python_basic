...
print(range(1,10,2))
print(list(range(1,10,2))) #1부터 10까지 2씩 증가
print(list(range(0,-15,-1))) # 0부터 -15까지 -1씩 한다면 0부터 -14까지 -1씩 증가
...
print(sorted([6,7,4,3,1,2])) #오름차순으로 정렬
